...
getService('GuiService').GamepadCursorEnabled = true
	...
	function Window:CreateTab(Name, Image, Ext)
		...
		function Tab:CreateButton(ButtonSettings)
			...
			Button.SelectionGained:Connect(function()
	            ...
	            TweenService:Create(Button.ElementIndicator, TweenInfo.new(0.25, Enum.EasingStyle.Exponential), {
